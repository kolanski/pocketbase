import{S as se,i as ne,s as ae,R as H,h as b,t as z,a as X,I as Q,a0 as ee,a1 as ye,C as te,ab as Te,D as le,l as v,n as u,u as p,v as S,A as D,w as k,k as L,o as oe,aa as Ee,d as Y,m as Z,c as x,a9 as Ce,T as fe,J as qe,p as Oe,X as pe}from"./index-DAuJCKg0.js";function me(a,t,e){const n=a.slice();return n[4]=t[e],n}function _e(a,t,e){const n=a.slice();return n[4]=t[e],n}function he(a,t){let e,n=t[4].code+"",d,c,r,o;function f(){return t[3](t[4])}return{key:a,first:null,c(){e=p("button"),d=D(n),c=S(),k(e,"class","tab-item"),L(e,"active",t[1]===t[4].code),this.first=e},m(g,y){v(g,e,y),u(e,d),u(e,c),r||(o=oe(e,"click",f),r=!0)},p(g,y){t=g,y&4&&n!==(n=t[4].code+"")&&Q(d,n),y&6&&L(e,"active",t[1]===t[4].code)},d(g){g&&b(e),r=!1,o()}}}function be(a,t){let e,n,d,c;return n=new Ee({props:{content:t[4].body}}),{key:a,first:null,c(){e=p("div"),x(n.$$.fragment),d=S(),k(e,"class","tab-item"),L(e,"active",t[1]===t[4].code),this.first=e},m(r,o){v(r,e,o),Z(n,e,null),u(e,d),c=!0},p(r,o){t=r;const f={};o&4&&(f.content=t[4].body),n.$set(f),(!c||o&6)&&L(e,"active",t[1]===t[4].code)},i(r){c||(X(n.$$.fragment,r),c=!0)},o(r){z(n.$$.fragment,r),c=!1},d(r){r&&b(e),Y(n)}}}function Ae(a){let t,e,n,d,c,r,o,f=a[0].name+"",g,y,F,q,J,N,U,O,A,T,C,R=[],M=new Map,j,W,h=[],K=new Map,E,P=H(a[2]);const B=l=>l[4].code;for(let l=0;l<P.length;l+=1){let s=_e(a,P,l),_=B(s);M.set(_,R[l]=he(_,s))}let m=H(a[2]);const G=l=>l[4].code;for(let l=0;l<m.length;l+=1){let s=me(a,m,l),_=G(s);K.set(_,h[l]=be(_,s))}return{c(){t=p("div"),e=p("strong"),e.textContent="POST",n=S(),d=p("div"),c=p("p"),r=D("/api/collections/"),o=p("strong"),g=D(f),y=D("/confirm-password-reset"),F=S(),q=p("div"),q.textContent="Body Parameters",J=S(),N=p("table"),N.innerHTML='<thead><tr><th>Param</th> <th>Type</th> <th width="50%">Description</th></tr></thead> <tbody><tr><td><div class="inline-flex"><span class="label label-success">Required</span> <span>token</span></div></td> <td><span class="label">String</span></td> <td>The token from the password reset request email.</td></tr> <tr><td><div class="inline-flex"><span class="label label-success">Required</span> <span>password</span></div></td> <td><span class="label">String</span></td> <td>The new password to set.</td></tr> <tr><td><div class="inline-flex"><span class="label label-success">Required</span> <span>passwordConfirm</span></div></td> <td><span class="label">String</span></td> <td>The new password confirmation.</td></tr></tbody>',U=S(),O=p("div"),O.textContent="Responses",A=S(),T=p("div"),C=p("div");for(let l=0;l<R.length;l+=1)R[l].c();j=S(),W=p("div");for(let l=0;l<h.length;l+=1)h[l].c();k(e,"class","label label-primary"),k(d,"class","content"),k(t,"class","alert alert-success"),k(q,"class","section-title"),k(N,"class","table-compact table-border m-b-base"),k(O,"class","section-title"),k(C,"class","tabs-header compact combined left"),k(W,"class","tabs-content"),k(T,"class","tabs")},m(l,s){v(l,t,s),u(t,e),u(t,n),u(t,d),u(d,c),u(c,r),u(c,o),u(o,g),u(c,y),v(l,F,s),v(l,q,s),v(l,J,s),v(l,N,s),v(l,U,s),v(l,O,s),v(l,A,s),v(l,T,s),u(T,C);for(let _=0;_<R.length;_+=1)R[_]&&R[_].m(C,null);u(T,j),u(T,W);for(let _=0;_<h.length;_+=1)h[_]&&h[_].m(W,null);E=!0},p(l,[s]){(!E||s&1)&&f!==(f=l[0].name+"")&&Q(g,f),s&6&&(P=H(l[2]),R=ee(R,s,B,1,l,P,M,C,ye,he,null,_e)),s&6&&(m=H(l[2]),te(),h=ee(h,s,G,1,l,m,K,W,Te,be,null,me),le())},i(l){if(!E){for(let s=0;s<m.length;s+=1)X(h[s]);E=!0}},o(l){for(let s=0;s<h.length;s+=1)z(h[s]);E=!1},d(l){l&&(b(t),b(F),b(q),b(J),b(N),b(U),b(O),b(A),b(T));for(let s=0;s<R.length;s+=1)R[s].d();for(let s=0;s<h.length;s+=1)h[s].d()}}}function Ne(a,t,e){let{collection:n}=t,d=204,c=[];const r=o=>e(1,d=o.code);return a.$$set=o=>{"collection"in o&&e(0,n=o.collection)},e(2,c=[{code:204,body:"null"},{code:400,body:`
            ...
            `}]),[n,d,c,r]}class We extends se{constructor(t){super(),ne(this,t,Ne,Ae,ae,{collection:0})}}function ve(a,t,e){const n=a.slice();return n[4]=t[e],n}function ke(a,t,e){const n=a.slice();return n[4]=t[e],n}function ge(a,t){let e,n=t[4].code+"",d,c,r,o;function f(){return t[3](t[4])}return{key:a,first:null,c(){e=p("button"),d=D(n),c=S(),k(e,"class","tab-item"),L(e,"active",t[1]===t[4].code),this.first=e},m(g,y){v(g,e,y),u(e,d),u(e,c),r||(o=oe(e,"click",f),r=!0)},p(g,y){t=g,y&4&&n!==(n=t[4].code+"")&&Q(d,n),y&6&&L(e,"active",t[1]===t[4].code)},d(g){g&&b(e),r=!1,o()}}}function we(a,t){let e,n,d,c;return n=new Ee({props:{content:t[4].body}}),{key:a,first:null,c(){e=p("div"),x(n.$$.fragment),d=S(),k(e,"class","tab-item"),L(e,"active",t[1]===t[4].code),this.first=e},m(r,o){v(r,e,o),Z(n,e,null),u(e,d),c=!0},p(r,o){t=r;const f={};o&4&&(f.content=t[4].body),n.$set(f),(!c||o&6)&&L(e,"active",t[1]===t[4].code)},i(r){c||(X(n.$$.fragment,r),c=!0)},o(r){z(n.$$.fragment,r),c=!1},d(r){r&&b(e),Y(n)}}}function De(a){let t,e,n,d,c,r,o,f=a[0].name+"",g,y,F,q,J,N,U,O,A,T,C,R=[],M=new Map,j,W,h=[],K=new Map,E,P=H(a[2]);const B=l=>l[4].code;for(let l=0;l<P.length;l+=1){let s=ke(a,P,l),_=B(s);M.set(_,R[l]=ge(_,s))}let m=H(a[2]);const G=l=>l[4].code;for(let l=0;l<m.length;l+=1){let s=ve(a,m,l),_=G(s);K.set(_,h[l]=we(_,s))}return{c(){t=p("div"),e=p("strong"),e.textContent="POST",n=S(),d=p("div"),c=p("p"),r=D("/api/collections/"),o=p("strong"),g=D(f),y=D("/request-password-reset"),F=S(),q=p("div"),q.textContent="Body Parameters",J=S(),N=p("table"),N.innerHTML='<thead><tr><th>Param</th> <th>Type</th> <th width="50%">Description</th></tr></thead> <tbody><tr><td><div class="inline-flex"><span class="label label-success">Required</span> <span>email</span></div></td> <td><span class="label">String</span></td> <td>The auth record email address to send the password reset request (if exists).</td></tr></tbody>',U=S(),O=p("div"),O.textContent="Responses",A=S(),T=p("div"),C=p("div");for(let l=0;l<R.length;l+=1)R[l].c();j=S(),W=p("div");for(let l=0;l<h.length;l+=1)h[l].c();k(e,"class","label label-primary"),k(d,"class","content"),k(t,"class","alert alert-success"),k(q,"class","section-title"),k(N,"class","table-compact table-border m-b-base"),k(O,"class","section-title"),k(C,"class","tabs-header compact combined left"),k(W,"class","tabs-content"),k(T,"class","tabs")},m(l,s){v(l,t,s),u(t,e),u(t,n),u(t,d),u(d,c),u(c,r),u(c,o),u(o,g),u(c,y),v(l,F,s),v(l,q,s),v(l,J,s),v(l,N,s),v(l,U,s),v(l,O,s),v(l,A,s),v(l,T,s),u(T,C);for(let _=0;_<R.length;_+=1)R[_]&&R[_].m(C,null);u(T,j),u(T,W);for(let _=0;_<h.length;_+=1)h[_]&&h[_].m(W,null);E=!0},p(l,[s]){(!E||s&1)&&f!==(f=l[0].name+"")&&Q(g,f),s&6&&(P=H(l[2]),R=ee(R,s,B,1,l,P,M,C,ye,ge,null,ke)),s&6&&(m=H(l[2]),te(),h=ee(h,s,G,1,l,m,K,W,Te,we,null,ve),le())},i(l){if(!E){for(let s=0;s<m.length;s+=1)X(h[s]);E=!0}},o(l){for(let s=0;s<h.length;s+=1)z(h[s]);E=!1},d(l){l&&(b(t),b(F),b(q),b(J),b(N),b(U),b(O),b(A),b(T));for(let s=0;s<R.length;s+=1)R[s].d();for(let s=0;s<h.length;s+=1)h[s].d()}}}function Me(a,t,e){let{collection:n}=t,d=204,c=[];const r=o=>e(1,d=o.code);return a.$$set=o=>{"collection"in o&&e(0,n=o.collection)},e(2,c=[{code:204,body:"null"},{code:400,body:`
                {
                  "status": 400,
                  "message": "An error occurred while validating the submitted data.",
                  "data": {
    ...
    `),A.$set(I),$&10){E=H(i[3]);let w;for(w=0;w<E.length;w+=1){const V=Re(i,E,w);P[w]?P[w].p(V,$):(P[w]=Pe(V),P[w].c(),P[w].m(j,null))}for(;w<P.length;w+=1)P[w].d(1);P.length=E.length}if($&11){B=H(i[3]);let w;for(w=0;w<B.length;w+=1){const V=$e(i,B,w);m[w]?(m[w].p(V,$),X(m[w],1)):(m[w]=Se(V),m[w].c(),X(m[w],1),m[w].m(h,null))}for(te(),w=B.length;w<m.length;w+=1)G(w);le()}},i(i){if(!K){X(A.$$.fragment,i);for(let $=0;$<B.length;$+=1)X(m[$]);K=!0}},o(i){z(A.$$.fragment,i),m=m.filter(Boolean);for(let $=0;$<m.length;$+=1)z(m[$]);K=!1},d(i){i&&(b(t),b(r),b(o),b(O),b(T),b(C),b(R),b(M)),Y(A,i),fe(P,i),fe(m,i)}}}function Fe(a,t,e){let n,{collection:d}=t;const c=[{title:"Request password reset",component:Be},{title:"Confirm password reset",component:We}];let r=0;const o=f=>e(1,r=f);return a.$$set=f=>{"collection"in f&&e(0,d=f.collection)},e(2,n=qe.getApiExampleUrl(Oe.baseURL)),[d,r,n,c,o]}class He extends se{constructor(t){super(),ne(this,t,Fe,Ie,ae,{collection:0})}}export{He as default};
